      ...
      <section className="max-w-5xl mx-auto px-5 md:px-6 py-12 md:py-16 space-y-10 md:space-y-12 leading-relaxed text-white/90">
        ...
        <section>
          ...
          <p className="text-base md:text-lg">
            ...
            du parti. Il met en œuvre les décisions des instances supérieures
            et coordonne les activités des différentes structures nationales et
            territoriales.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-base md:text-lg">
            ...
            Président National. Il travaille de manière permanente pour garantir
            l’efficacité de l’action politique, la coordination des structures
            territoriales et la gestion harmonieuse du parti.
          </p>
        </section>
