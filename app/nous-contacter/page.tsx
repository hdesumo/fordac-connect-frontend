...
export default function ContactPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-12 text-gray-100">
      <h1 className="text-3xl font-bold text-[#c8a45d] mb-6">Nous Contacter</h1>
      ...
      {done ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-5 bg-[#0f3a2d] p-6 rounded-lg border border-[#1d6047]">
          <div>
            <label>Nom complet</label>
            <input name="name" required className="w-full px-4 py-2 rounded bg-[#0c2e25]" />
          </div>

          <div>
            <label>Email</label>
            <input name="email" type="email" required className="w-full px-4 py-2 rounded bg-[#0c2e25]" />
          </div>

          <div>
            <label>Message</label>
            <textarea name="message" rows={6} required className="w-full px-4 py-3 rounded bg-[#0c2e25]" />
          </div>
