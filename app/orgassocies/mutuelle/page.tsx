...
export default function MutuelleFordacPage() {
  return (
    <main className="min-h-screen bg-fordacDark text-white">
      ...
      <section className="max-w-5xl mx-auto px-5 md:px-6 py-12 md:py-16 space-y-12 leading-relaxed text-white/90">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 md:pl-6 space-y-2 text-white/90 mb-6 text-base md:text-lg">
