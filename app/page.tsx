...
export default function HomePage() {
  // ✅ Correction de la définition des variantes avec typage compatible
  const sectionVariants = {
    hidden: { opacity: 0, y: 30 },
    visible: (delay = 0) => ({
      opacity: 1,
      y: 0,
      transition: { duration: 0.8, delay, ease: "easeOut" as any }, // ✅ typage corrigé
    }),
  };
  ...
  return (
    <main className="flex flex-col min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-green-50 to-white dark:from-gray-900 dark:to-gray-950 py-20">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 drop-shadow-xl text-green-800 dark:text-green-400">
            Forces Démocratiques pour l’Action et le Changement
          </h1>
          <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 leading-relaxed mb-8">
            Le FORDAC est un mouvement politique né de la volonté de bâtir un Cameroun
            plus juste, participatif et tourné vers l’avenir. Il incarne les valeurs
            de solidarité, de justice sociale et de développement équitable.
          </p>
